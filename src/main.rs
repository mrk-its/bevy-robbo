...
use bevy::window;
use components::{Kind, StartPosition};
...
use systems::{
    create_sprites, game_event_system, keyboard_system, move_robbo, move_system, prepare_render,
    render_setup, shot_system,
};
...
fn main() {
    App::build()
        ...
        .add_stage_after("pre_update2", "pre_update3")
        ...
        .add_system_to_stage("pre_update3", keyboard_system.system())
